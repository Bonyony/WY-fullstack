    ...
    <>
      <aside className="md:ml-8">
        <img
          ...
          className="bg-primary p-2 max-h-[100px] max-w-[100px] rounded-full hover:bg-gray-300 transition-all duration-500"
        />
        <p>
          Hyrax Corporation ltd.
          <br />
        ...
        <div className="grid grid-flow-col gap-4">
          <a>
            <svg
              ...
              height="24"
              viewBox="0 0 24 24"
              className="fill-current hover:fill-blue-500 cursor-pointer"
            >
          ...
          <a>
            <svg
              ...
              height="24"
              viewBox="0 0 24 24"
              className="fill-current hover:fill-red-500 cursor-pointer"
            >
